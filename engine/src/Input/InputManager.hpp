...
public:
    ...
    /**
      * The code for the keys and the buttons(Merge OIS's mouse button ID with its key code).
      */
    enum InputCode {
        KC_UNASSIGNED  = 0x00,
        KC_ESCAPE      = 0x01,
        ...
        MC_LEFT        = 0xEE,    // Left Mouse Button
        MC_RIGHT       = 0xEF,    // Right Mouse Button
        MC_MIDDLE      = 0xF0,    // Middle Mouse Button
        MC_BUTTON3     = 0xF1,    // Mouse Button 3
